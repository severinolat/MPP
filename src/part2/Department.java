...
public class Department {
   ...
   public double getTotalSalary2() {
	...
	public void studentByFaculty(String facultyName) {
		if(facultyName == null) System.out.println("Invalid name");
		List<Course> courses = new ArrayList<Course>();
		for(Person p : persons) {
			if(facultyName.equals(p.getName())) {
				Faculty fp = (Faculty) p;
				courses.addAll(fp.getCourses());
			}
